          ...
          >
            ...
            <div className={`rounded-2xl p-8 mt-8 ${
              ...
              <p className={`leading-relaxed ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                <span className={darkMode ? 'text-cyan-400' : 'text-cyan-600'}> AI-drevne assistenter</span> forbedrer dialogen med kunder og ansatte. Sammen skaper vi et helhetlig digitalt økosystem <span className={darkMode ? 'text-cyan-400' : 'text-cyan-600'}>som sparer tid, reduserer kostnader og gir målbar forretningsverdi</span>  
